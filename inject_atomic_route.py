...
def inject_atomic_route():
    host = "ssh-quickcombo.alwaysdata.net"
    user = "quickcombo"
    password = "Dinesh@061004"
    
    # THE CONFIRMED LIVE DIRECTORY
...
urlpatterns = [
    # ATOMIC TEST (TOP PRIORITY)
    path("atomic-test/", lambda r: HttpResponse("ALIVE!")),
...
'''
    ...
    try:
        ...
        print(f"Connected! Injecting Atomic Test into {LIVE_ROOT}...")
        
        sftp = ssh.open_sftp()
        remote_path = f"{LIVE_ROOT}/api/urls.py"

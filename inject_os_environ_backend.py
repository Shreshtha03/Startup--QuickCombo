...
def inject_os_environ_backend():
    ...
    try:
        ...
        new_content = content.replace(
            '"error": None,', 
            '"error": None, "live_code_path": "www/quickcombo_backend", "my_env_db": os.environ.get("DATABASE_URL", "NOT_SET"), "db_engine": settings.DATABASES["default"]["ENGINE"], "db_name": str(settings.DATABASES["default"]["NAME"]),'
        )
